...
export default function ReportesPage() {
  ...
  // ── Por usuario (solo comprobados, filtros mes + área) ───────────────
...
git add .
git commit -m "feat: reembolso liberado→comprobado auto, reportes Por area/cuenta/usuario solo comprobados"
git push
echo "✓ Done"
echo ""
echo "Después: ejecutar reembolsos-a-comprobado.sql en Supabase para migrar reembolsos liberados existentes"