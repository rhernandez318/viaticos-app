...
git add .
git commit -m "feat: admin validation step in approval workflow, validado status"
git push
echo ""
echo "✓ Deployed! Nuevo flujo:"
echo "  solicitado → Aut.Gerente(autorizado) → Aut.Admin(validado) → Liberado → Comprobado"
echo ""
echo "Pendiente en Supabase: ejecutar limites-gasto.sql"